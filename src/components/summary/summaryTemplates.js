...
export function summaryCardsTemplate(summary) {
  return `
...
export function topNumbersTemplate(topNumbers) {
...
export function transactionsTableTemplate(transactions) {
...
export function pageTemplate(summary, transactions) {
  return `
