...
// File 1: customerTemplates.js
const customerTemplatesContent = `// ===== CUSTOMER TEMPLATES - ส่วนแสดงผล UI =====
...
fs.writeFileSync(path.join(dir, 'customerTemplates.js'), customerTemplatesContent);
console.log('Created: customerTemplates.js');

// File 2: customerHandlers.js
const customerHandlersContent = `// ===== CUSTOMER HANDLERS - ส่วนจัดการ Event Handlers =====
...
fs.writeFileSync(path.join(dir, 'customerHandlers.js'), customerHandlersContent);
console.log('Created: customerHandlers.js');

// File 3: customerEvents.js
const customerEventsContent = `// ===== CUSTOMER EVENTS - ส่วน Event Binding =====
...
fs.writeFileSync(path.join(dir, 'customerEvents.js'), customerEventsContent);
console.log('Created: customerEvents.js');

// File 4: customerPage.js
const customerPageContent = `// ===== CUSTOMER PAGE - จัดการลูกค้า =====
...
fs.writeFileSync(path.join(dir, 'customerPage.js'), customerPageContent);
console.log('Created: customerPage.js');
